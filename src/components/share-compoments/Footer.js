...
function Footer() {
    ...
    if (contact.length === 0 || !contact || error) {
        return (message = "Opps something went wrong. Please refresh the page")
    } else {
                    ...
                    <div className="row">
                        ...
                        <div className="col-sm-12 col-md-4 col-lg-3 mt-3 mt-lg-5">
                            <ul className="footer-sitemap">
                                <Link to="/" className="footer-item mx-sm-1 mx-md-3 mx-lg-5">
                                    <p className="footer-link">Trang chủ</p>
                                </Link>
                                <Link to="/product" className="footer-item mx-sm-1 mx-md-3 mx-lg-5">
                                    <p className="footer-link">Sản phẩm</p>
                                </Link>
                                <Link to="/blog" className="footer-item mx-sm-1 mx-md-3 mx-lg-5">
                                    <p className="footer-link">Bài viết</p>
                                </Link>
                                <Link to="/contact" className="footer-item mx-sm-1 mx-md-3 mx-lg-5">
